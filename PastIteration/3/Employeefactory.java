...
{
    public static Employee createEmployee(String name, int age, String address, String employeeID, Department department, double salary, BonusStrategy bonusStrategy, Role role, Location location) 
    {
        switch (role) 
        {
            case MANAGER:
